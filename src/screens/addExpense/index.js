...
// this is for the date
  ...
  const hideDateTimePicker = () => {
    ...
    const returnBack = () => {
      ...
      // this is to navigate to add Multiple expenses
      const addMultiple = () => {
        props.navigation.navigate('AddMultipleExpenses')
    }
        ...
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                ...
                <View style={styles.topSmTitle}>
                    <Text style={styles.topSmTitleText}>Expense Details</Text>
                </View>
                ...
                <View style={styles.recordsContainer}>
                    ...
                    <View style={styles.btnCover}>
                        <BtnLg title="Add more Expenses" style={styles.createBtn1} onPress={addMultiple} styles={styles.btnText} />
                    </View>
