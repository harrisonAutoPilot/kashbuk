...
const Quotation = (props) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <NavHeaderWhiteTwo title="Quotation" onPress={returnBack} />
            <ScrollView
        ...
        <Text style={styles.descripTitle}>amount</Text>
            ...
            {data.map((item) => (
               ...
               <View style={styles.addressCover}>
                        ...
                        <View style={styles.addressContainer}>
                            <Text style={styles.address}>Payment Terms Payment within 14 days from invoice Quotation without deductions</Text>
                        </View>
                </View>
                <BtnLg title="Send Quotation" style={styles.createBtn1} on styles={styles.btnText} />
