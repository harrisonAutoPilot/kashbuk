    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                <NavHeaderWhite onPress={returnBack1} />
                <View style={styles.topSmTitle}>
                    <Text style={styles.topSmTitleText}>Add Quote Item</Text>
                </View>
        ...
        <Fcon name="x" size={20} color="#000" style={{paddingLeft:5}} />
                    ...
                    <View style={{ marginTop: 0 }}>
                        ...
                        <View style={styles.btnCover}>
                            <BtnLg title="Create Quotation"  onPress={() => props.navigation.navigate("Homee")} />
